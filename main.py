...
async def main():
  user = Client("scrapper",
                api_id="20508907",
                api_hash="151af24fec3740cf4533ba474e3270ef")
  bot = Client("my_bot",
               api_id="20508907",
               api_hash="151af24fec3740cf4533ba474e3270ef",
               bot_token="6877222609:AAHHH-QvSpC9Eb78ezPm3n_GMiNRcKUBMaw",
               plugins=plugins)
  clients = [user, bot]
...
<code>/scr https://t.me/+aGWRGz 50</code>
      ...
      if results == 'None':
        ...
        if chat_type == "ChatType.PRIVATE" and status == "FREE":
          ...
          resp = "𝗨𝗡𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘𝗗 𝗖𝗛𝗔𝗧 ❌. 𝗖𝗢𝗡𝗧𝗔𝗖𝗧 @mR_oMeNxD 𝗧𝗢 𝗔𝗨𝗧𝗛𝗢𝗥𝗜𝗭𝗘."
          await message.reply_text(resp, message.id)
        else:
          #CREDIT CHECK
                ...
                try:
                  ...
                  async for msg in user.get_chat_history(channel_id, limit):
                    ...
                    for item in cards:
                      ...
                      file_name = f"{limit}x_CC_Scraped_By_@OmenXDBot.txt"
...
● 𝗕𝗼𝘁 𝗕𝘆: <a href="tg://user?id=1667886379">[ 🇮🇳 ] 𓆩 𝑴𝑹 𝑶𝑴𝑬𝑵 ✘𝑫 𓆪 | ✖️! </a>
"""
                  document = file_name
